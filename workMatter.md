...
- [ ] **Re-point `/run-test` and `/run-fulltest` at the 2.0 stack** - the skills still assume the 1.x single-file app (`legacy/`); they should run Vitest/pytest and drive the Vite + FastAPI dev servers instead.
